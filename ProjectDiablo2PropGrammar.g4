...
// item_openwounds 4 1 ModStr3m ModStr3m 
...
// item_deadlystrike 4 1 ModStr5q ModStr5q 
item_deadlystrike: percentage 'chance' 'of' 'deadly' 'strike';
...
// extra_shadow 1 1 ExtraShadow ExtraShadow 
extra_shadow: percentage 'to' 'maximum' 'shadows';
// extra_spiritwolf 1 1 ExtraSpiritWolf ExtraSpiritWolf 
extra_spiritwolf: percentage 'to' 'maximum' 'spirit' 'wolves';
...
item_deadlystrike_perlevel: percentage 'chance' 'of' 'deadly' 'strike' '(' 'based' 'on' 'character' 'level' ')';
...
// item_crit_multiplier 4 1 StrCritMultiplierStat StrCritMultiplierStat 
item_crit_multiplier: percentage 'critical' 'strike' 'multiplier';
// item_ds_multiplier 4 1 StrDSMultiplierStat StrDSMultiplierStat 
item_ds_multiplier: percentage 'deadly' 'strike' 'multiplier';
// item_crit_chance 4 1 StrCritChanceStat StrCritChanceStat 
item_crit_chance: percentage 'chance' 'of' 'critical' 'strike';
...
map_glob_dropsocketed: 'monsters' 'have' percentage '%%' 'chance' 'to' 'drop' 'socketed' 'itemsmap' 'boss' 'drops' 'socketed' 'uniques';
// map_glob_dropbonus 19 0 MapGlobDropBonus MapGlobDropBonus 
map_glob_dropbonus: 'monsters' 'have' percentage '%%' 'chance' 'to' 'drop' 'extra' 'items';
// map_glob_dropethereal 19 0 MapGlobDropEthereal MapGlobDropEthereal 
map_glob_dropethereal: 'monsters' 'have' percentage '%%' 'chance' 'to' 'drop' 'ethereal' 'itemsmap' 'boss' 'drops' 'ethereal' 'uniques';
// map_glob_bossdropstreasure 19 0 MapGlobBossTreasure MapGlobBossTreasure 
map_glob_bossdropstreasure: 'map' 'boss' 'drops' 'a' 'treasure' 'explosion';
// treacherous 3 0 StrTreacherous StrTreacherous 
treacherous: 'treacherous';
// map_mon_att 8 2 MapMonHave MapMonHave ModStr1h
map_mon_att: 'monsters' 'have' percentage 'to' 'attack' 'rating';
...
// extra_revives 1 1 StrExtraRevives2 StrExtraRevives2 
extra_revives: percentage 'to' 'maximum' 'revives';
...
map_mon_deadlystrike: 'monsters' 'have' percentage 'chance' 'of' 'deadly' 'strike';
...
map_play_damageresist: 'players' 'have' percentage 'physical' 'damage' 'reduction';
...
heroic: 'heroic';
// extra_spirits 1 1 StrExtraSpirits StrExtraSpirits 
extra_spirits: percentage 'to' 'maximum' 'spirits';
// gustreduction 3 0 GustReduction GustReduction 
gustreduction: 'gust' 'cooldown' 'reduced' 'by' exact_integer 'seconds';
// extra_skele_war 1 1 ExtraSkeleWar ExtraSkeleWar 
extra_skele_war: percentage 'to' 'maximum' 'skeleton' 'warriors';
// extra_skele_mage 1 1 ExtraSkeleMage ExtraSkeleMage 
extra_skele_mage: percentage 'to' 'maximum' 'skeleton' 'mages';
// extra_hydra 1 1 ExtraHydra ExtraHydra 
extra_hydra: percentage 'to' 'maximum' 'hydras';
// extra_valk 1 1 ExtraValk ExtraValk 
extra_valk: percentage 'to' 'maximum' 'valkyries';
// joustreduction 3 0 joustreduction joustreduction 
joustreduction: 'joust' 'cooldown' 'reduced' 'by' '0.5' 'seconds';
// grims_extra_skele_mage 1 1 ExtraSkeleMageGrim ExtraSkeleMageGrim 
grims_extra_skele_mage: percentage 'to' 'maximum' 'skeleton' 'mages';
...
// extra_skele_archer 1 1 ExtraSkeleArcher ExtraSkeleArcher 
extra_skele_archer: percentage 'to' 'maximum' 'skeleton' 'archers';
// extra_golem 1 1 ExtraGolem ExtraGolem 
extra_golem: percentage 'to' 'maximum' 'golems';
