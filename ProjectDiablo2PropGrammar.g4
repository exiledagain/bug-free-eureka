...
item_addclassskills: percentage ('to' class 'skill' 'levels' | 'to' class 'skill' 'levels' | 'to' class 'skill' 'levels' | 'to' class 'skill' 'levels' | 'to' class 'skill' 'levels' | 'to' class 'skill' 'levels' | 'to' class 'skill' 'levels');
...
any_skill: ('attack' | 'attack' | 'kick' | 'kick' | 'throw' | 'throw' | 'unsummon' | 'unsummon' | 'left' 'hand' 'throw' | 'left' 'hand' 'throw' | 'left' 'hand' 'swing' | 'left' 'hand' 'swing' | 'magic' 'arrow' | 'magic' 'arrow' | 'fire' 'arrow' | 'fire' 'arrow' | 'inner' 'sight' | 'inner' 'sight' | 'critical' 'strike' | 'critical' 'strike' | 'jab' | 'jab' | 'cold' 'arrow' | 'cold' 'arrow' | 'multiple' 'shot' | 'multiple' 'shot' | 'dodge' | 'dodge' | 'power' 'strike' | 'power' 'strike' | 'poison' 'javelin' | 'poison' 'javelin' | 'exploding' 'arrow' | 'exploding' 'arrow' | 'slow' 'movement' | 'slow' 'movement' | 'avoid' | 'avoid' | 'javelin' 'and' 'spear' 'mastery' | 'javelin' 'and' 'spear' 'mastery' | 'lightning' 'bolt' | 'lightning' 'bolt' | 'ice' 'arrow' | 'ice' 'arrow' | 'guided' 'arrow' | 'guided' 'arrow' | 'penetrate' | 'penetrate' | 'charged' 'strike' | 'charged' 'strike' | 'plague' 'javelin' | 'plague' 'javelin' | 'strafe' | 'strafe' | 'immolation' 'arrow' | 'immolation' 'arrow' | 'decoy' | 'dopplezon' | 'evade' | 'evade' | 'fend' | 'fend' | 'freezing' 'arrow' | 'freezing' 'arrow' | 'valkyrie' | 'valkyrie' | 'pierce' | 'pierce' | 'lightning' 'strike' | 'lightning' 'strike' | 'lightning' 'fury' | 'lightning' 'fury' | 'fire' 'bolt' | 'fire' 'bolt' | 'warmth' | 'warmth' | 'charged' 'bolt' | 'charged' 'bolt' | 'ice' 'bolt' | 'ice' 'bolt' | 'cold' 'enchant' | 'cold' 'enchant' | 'inferno' | 'inferno' | 'static' 'field' | 'static' 'field' | 'telekinesis' | 'telekinesis' | 'frost' 'nova' | 'frost' 'nova' | 'ice' 'blast' | 'ice' 'blast' | 'blaze' | 'blaze' | 'fire' 'ball' | 'fire' 'ball' | 'nova' | 'nova' | 'lightning' | 'lightning' | 'shiver' 'armor' | 'shiver' 'armor' | 'fire' 'wall' | 'fire' 'wall' | 'enchant' 'fire' | 'enchant' | 'chain' 'lightning' | 'chain' 'lightning' | 'teleport' | 'teleport' | 'glacial' 'spike' | 'glacial' 'spike' | 'meteor' | 'meteor' | 'thunder' 'storm' | 'thunder' 'storm' | 'energy' 'shield' | 'energy' 'shield' | 'blizzard' | 'blizzard' | 'chilling' 'armor' | 'chilling' 'armor' | 'fire' 'mastery' | 'fire' 'mastery' | 'hydra' | 'hydra' | 'lightning' 'mastery' | 'lightning' 'mastery' | 'frozen' 'orb' | 'frozen' 'orb' | 'cold' 'mastery' | 'cold' 'mastery' | 'amplify' 'damage' | 'ampdmg' | 'teeth' | 'teeth' | 'bone' 'armor' | 'bone' 'armor' | 'skeleton' 'mastery' | 'skeleton' 'mastery' | 'raise' 'skeleton' 'warrior' | 'raise' 'skeleton' | 'dim' 'vision' | 'dim' 'vision' | 'weaken' | 'weaken' | 'poison' 'strike' | 'poison' 'dagger' | 'corpse' 'explosion' | 'corpse' 'explosion' | 'clay' 'golem' | 'clay' 'golem' | 'iron' 'maiden' | 'iron' 'maiden' | 'terror' | 'terror' | 'bone' 'wall' | 'bone' 'wall' | 'golem' 'mastery' | 'golem' 'mastery' | 'raise' 'skeletal' 'mage' | 'raise' 'skeletal' 'mage' | 'confuse' | 'confuse' | 'life' 'tap' | 'life' 'tap' | 'desecrate' | 'desecrate' | 'bone' 'spear' | 'bone' 'spear' | 'blood' 'golem' | 'bloodgolem' | 'attract' | 'attract' | 'decrepify' | 'decrepify' | 'bone' 'prison' | 'bone' 'prison' | 'raise' 'skeleton' 'archer' | 'raise' 'skeleton' 'archer' | 'iron' 'golem' | 'irongolem' | 'lower' 'resist' | 'lowres' | 'poison' 'nova' | 'poison' 'nova' | 'bone' 'spirit' | 'bone' 'spirit' | 'fire' 'golem' | 'firegolem' | 'revive' | 'revive' | 'sacrifice' | 'sacrifice' | 'smite' | 'smite' | 'might' | 'might' | 'prayer' | 'prayer' | 'resist' 'fire' | 'resist' 'fire' | 'holy' 'bolt' | 'holy' 'bolt' | 'holy' 'fire' | 'holy' 'fire' | 'thorns' | 'thorns' | 'defiance' | 'defiance' | 'resist' 'cold' | 'resist' 'cold' | 'zeal' | 'zeal' | 'charge' | 'charge' | 'blessed' 'aim' | 'blessed' 'aim' | 'cleansing' | 'cleansing' | 'resist' 'lightning' | 'resist' 'lightning' | 'vengeance' | 'vengeance' | 'blessed' 'hammer' | 'blessed' 'hammer' | 'concentration' | 'concentration' | 'holy' 'freeze' | 'holy' 'freeze' | 'vigor' | 'vigor' | 'holy' 'sword' | 'holy' 'sword' | 'holy' 'shield' | 'holy' 'shield' | 'holy' 'shock' | 'holy' 'shock' | 'sanctuary' | 'sanctuary' | 'meditation' | 'meditation' | 'fist' 'of' 'the' 'heavens' | 'fist' 'of' 'the' 'heavens' | 'fanaticism' | 'fanaticism' | 'conviction' | 'conviction' | 'redemption' | 'redemption' | 'salvation' | 'salvation' | 'bash' | 'bash' | 'sword' 'mastery' | 'sword' 'mastery' | 'general' 'mastery' | 'general' 'mastery' | 'mace' 'mastery' | 'mace' 'mastery' | 'howl' | 'howl' | 'find' 'potion' | 'find' 'potion' | 'leap' | 'leap' | 'double' 'swing' | 'double' 'swing' | 'polearm' 'and' 'spear' 'mastery' | 'pole' 'arm' 'and' 'spear' 'mastery' | 'throwing' 'mastery' | 'throwing' 'mastery' | 'spear' 'mastery' | 'spear' 'mastery' | 'taunt' | 'taunt' | 'shout' | 'shout' | 'stun' | 'stun' | 'double' 'throw' | 'double' 'throw' | 'combat' 'reflexes' | 'combat' 'reflexes' | 'find' 'item' | 'find' 'item' | 'leap' 'attack' | 'leap' 'attack' | 'concentrate' | 'concentrate' | 'iron' 'skin' | 'iron' 'skin' | 'battle' 'cry' | 'battle' 'cry' | 'frenzy' | 'frenzy' | 'increased' 'speed' | 'increased' 'speed' | 'battle' 'orders' | 'battle' 'orders' | 'grim' 'ward' | 'grim' 'ward' | 'whirlwind' | 'whirlwind' | 'berserk' | 'berserk' | 'natural' 'resistance' | 'natural' 'resistance' | 'war' 'cry' | 'war' 'cry' | 'battle' 'command' | 'battle' 'command' | 'meteor' | 'vampiremeteor' | 'scroll' 'of' 'identify' | 'scroll' 'of' 'identify' | 'tome' 'of' 'identify' | 'book' 'of' 'identify' | 'scroll' 'of' 'townportal' | 'scroll' 'of' 'townportal' | 'tome' 'of' 'townportal' | 'book' 'of' 'townportal' | 'raven' | 'raven' | 'poison' 'creeper' | 'plague' 'poppy' | 'werewolf' | 'wearwolf' | 'lycanthropy' | 'shape' 'shifting' | 'firestorm' | 'firestorm' | 'oak' 'sage' | 'oak' 'sage' | 'summon' 'spirit' 'wolf' | 'summon' 'spirit' 'wolf' | 'werebear' | 'wearbear' | 'molten' 'boulder' | 'molten' 'boulder' | 'arctic' 'blast' | 'arctic' 'blast' | 'carrion' 'vine' | 'cycle' 'of' 'life' | 'feral' 'rage' | 'feral' 'rage' | 'maul' | 'maul' | 'fissure' | 'eruption' | 'cyclone' 'armor' | 'cyclone' 'armor' | 'heart' 'of' 'wolverine' | 'heart' 'of' 'wolverine' | 'summon' 'dire' 'wolf' | 'summon' 'fenris' | 'rabies' | 'rabies' | 'fire' 'claws' | 'fire' 'claws' | 'twister' | 'twister' | 'solar' 'creeper' | 'vines' | 'hunger' | 'hunger' | 'shock' 'wave' | 'shock' 'wave' | 'volcano' | 'volcano' | 'tornado' | 'tornado' | 'spirit' 'of' 'barbs' | 'spirit' 'of' 'barbs' | 'summon' 'grizzly' | 'summon' 'grizzly' | 'fury' | 'fury' | 'armageddon' | 'armageddon' | 'hurricane' | 'hurricane' | 'fire' 'blast' | 'fire' 'trauma' | 'claw' 'and' 'dagger' 'mastery' | 'claw' 'mastery' | 'psychic' 'hammer' | 'psychic' 'hammer' | 'tiger' 'strike' | 'tiger' 'strike' | 'dragon' 'talon' | 'dragon' 'talon' | 'shock' 'web' | 'shock' 'field' | 'blade' 'sentinel' | 'blade' 'sentinel' | 'burst' 'of' 'speed' | 'quickness' | 'fists' 'of' 'fire' | 'fists' 'of' 'fire' | 'dragon' 'claw' | 'dragon' 'claw' | 'charged' 'bolt' 'sentry' | 'charged' 'bolt' 'sentry' | 'wake' 'of' 'fire' | 'wake' 'of' 'fire' 'sentry' | 'weapon' 'block' | 'weapon' 'block' | 'cloak' 'of' 'shadows' | 'cloak' 'of' 'shadows' | 'cobra' 'strike' | 'cobra' 'strike' | 'blade' 'fury' | 'blade' 'fury' | 'fade' | 'fade' | 'shadow' 'warrior' | 'shadow' 'warrior' | 'claws' 'of' 'thunder' | 'claws' 'of' 'thunder' | 'dragon' 'tail' | 'dragon' 'tail' | 'chain' 'lightning' 'sentry' | 'chain' 'lightning' 'sentry' | 'wake' 'of' 'inferno' | 'inferno' 'sentry' | 'mind' 'blast' | 'mind' 'blast' | 'blades' 'of' 'ice' | 'blades' 'of' 'ice' | 'dragon' 'flight' | 'dragon' 'flight' | 'death' 'sentry' | 'death' 'sentry' | 'blade' 'shield' | 'blade' 'shield' | 'venom' | 'venom' | 'shadow' 'master' | 'shadow' 'master' | 'phoenix' 'strike' | 'royal' 'strike' | 'delirium' | 'delerium' 'change' | 'blink' | 'blink' | 'battle' 'orders' | 'battleorderscta' | 'immolation' 'arrow' | 'bloodravenimmo' | 'holy' 'nova' | 'holy' 'nova' | 'freezing' 'arrow' | 'shattering' 'arrow' | 'lightning' 'sentry' | 'lightning' 'sentry' | 'blood' 'warp' | 'blood' 'warp' | 'deep' 'wounds' | 'deep' 'wounds' | 'ice' 'barrage' | 'ice' 'barrage' | 'gust' | 'gust' | 'holy' 'light' | 'holy' 'light' | 'curse' 'mastery' | 'curmas' | 'combustion' | 'combustion' | 'joust' | 'joust' | 'dark' 'pact' | 'dark' 'pact' | 'lesser' 'hydra' | 'lesser' 'hydra' | 'fire' 'arrow' | 'merc' 'fire' 'arrow' | 'cold' 'arrow' | 'merc' 'cold' 'arrow' | 'vampire' 'form' | 'vampire' 'form' | 'lesser' 'fade' | 'lesser' 'fade' | 'move' 'only' | 'force' 'move' | 'bone' 'nova' | 'fingermagebossnova' | 'leap' | 'monleap' | 'jab' | 'monjab' | 'smite' | 'monsmite' | 'charge' | 'moncharge' | 'holy' 'freeze' | 'monholyfreeze' | 'glacial' 'spike' | 'monglacialspike' | 'frost' 'nova' | 'monfrostnova' | 'fire' 'ball' | 'monfireball' | 'weaken' | 'monweaken' | 'hydra' | 'monhydra' | 'lightning' | 'monlightning' | 'whirlwind' | 'monwhirlwind' | 'shout' | 'monshout' | 'decrepify' | 'mondecrepify' | 'chain' 'lightning' | 'monchainlightning' | 'chilling' 'armor' | 'monchillingarmor' | 'meteor' | 'uberdiablometeor' | 'immolation' 'arrow' | 'uberdiabloboulder' | 'chain' 'lightning' | 'wispbosschainlightning' | 'lightning' | 'wispminionlightning' | 'conviction' | 'wisptotemconviction' | 'leap' 'attack' | 'monleapattack' | 'amplify' 'damage' | 'ampdmg' 'proc' | 'weaken' | 'weaken' 'proc' | 'iron' 'maiden' | 'iron' 'maiden' 'proc' | 'life' 'tap' | 'life' 'tap' 'proc' | 'decrepify' | 'decrepify' 'proc' | 'lower' 'resist' | 'lowres' 'proc' | 'freezing' 'arrow' | 'iceboss' 'freezing' 'arrow' | 'blizzard' | 'iceboss' 'blizzard' | 'lightning' 'strike' | 'lightning' 'strike' 'cowboss' | 'poison' 'nova' | 'poison' 'nova' 'tomb' 'boss' | 'power' 'strike' | 'power' 'strike' 'tomb' 'boss' | 'hydra' | 'hydra' 'throne' 'boss' | 'hurricane' | 'hurricanetortureboss' | 'static' 'field' | 'merc' 'static' 'field' | 'lightning' | 'a3' 'merc' 'lightning' | 'meteor' | 'a3' 'merc' 'meteor' | 'fire' 'ball' | 'a3' 'merc' 'fire' 'ball' | 'blizzard' | 'a3' 'merc' 'blizzard' | 'ice' 'blast' | 'a3' 'merc' 'ice' 'blast' | 'blessed' 'aim' | 'traitorbossblessedaim' | 'vigor' | 'traitorbossvigor' | 'teeth' | 'traitorbossconejab' | 'bone' 'spear' | 'traitorbossstunspear' | 'blizzard' | 'archerbossarrowrain' | 'multiple' 'shot' | 'archerbossboomershot' | 'multiple' 'shot' | 'archerbosscageshot' | 'conviction' | 'mon' 'conviction' | 'fanaticism' | 'mon' 'fanaticism' | 'holy' 'shock' | 'mon' 'holy' 'shock' | 'holy' 'freeze' | 'mon' 'holy' 'freeze' | 'holy' 'fire' | 'mon' 'holy' 'fire' | 'might' | 'mon' 'might' | 'concentration' | 'mon' 'concentration' | 'vigor' | 'mon' 'vigor' | 'lower' 'resist' | 'baal' 'lowres' | 'poison' 'strike' | 'poison' 'dagger' 'spider' 'boss' | 'tornado' | 'tornado' 'arcane' 'boss' | 'power' 'strike' | 'valk' 'power' 'strike' | 'bone' 'spear' | 'rathmabonespear' | 'teeth' | 'rathmateethnova' | 'hurricane' | 'iskatuhurricane' | 'fissure' | 'rathmafissure' | 'poison' 'nova' | 'rathmaouternova' | 'frost' 'nova' | 'frost' 'nova' 'horror' 'boss' | 'holy' 'freeze' | 'mon' 'holy' 'freeze' 'wide' | 'poison' 'nova' | 'rathmapacman' | 'shock' 'wave' | 'shock' 'wave' 'boss' | 'glacial' 'spike' | 'glacial' 'spike' 'spire' | 'poison' 'nova' | 'poison' 'nova' 'rathma' | 'teeth' | 'teeth' 'rathma' | 'blaze' | 'ubertalicblaze' | 'whirlwind' | 'ubertalicwhirlwind' | 'bash' | 'ubertalicbash' | 'meteor' | 'ubertalicmeteor' | 'identify' 'all' | 'book' 'of' 'unlimited' 'identify' | 'create' 'townportal' | 'book' 'of' 'unlimited' 'townportal' | 'meteor' | 'brutefireslam' | 'molten' 'boulder' | 'brutemoltenboulder' | 'shock' 'wave' | 'bruteshockwave' | 'vigor' | 'brutevigor' | 'smite' | 'ubertalicsmite' | 'battle' 'orders' | 'ubermadawcfakebo' | 'blizzard' | 'ubermadawclightningstorm' | 'cyclone' 'armor' | 'cyclone' 'armormon' | 'volcano' | 'siegebeastclusterbomb' | 'nova' | 'siegebeastfirenova' | 'frozen' 'orb' | 'siegebeastorb' | 'holy' 'fire' | 'holy' 'fire' 'fire' 'golem' | 'holy' 'freeze' | 'holy' 'freeze' 'korlic' | 'leap' 'attack' | 'leap' 'attack' 'korlic' | 'holy' 'fire' | 'holy' 'fire' 'sanctuaryboss' | 'howl' | 'howl' 'monster' | 'bone' 'spear' | 'bone' 'spear' 'serpent' | 'fire' 'ball' | 'fire' 'ball' 'ashen' 'boss' | 'frost' 'nova' | 'fire' 'nova' | 'ice' 'barrage' | 'zharbarrage' | 'armageddon' | 'zhararmageddon' | 'cloak' 'of' 'shadows' | 'zharcloak' | 'magic' 'arrow' | 'merc' 'magic' 'arrow' | 'amplify' 'damage' | 'a4' 'ampdmg' | 'energy' 'shield' | 'energy' 'shield' 'selfaura' | 'chilling' 'armor' | 'chilling' 'armor' 'selfaura' | 'burst' 'of' 'speed' | 'quickness' 'selfaura' | 'blade' 'shield' | 'blade' 'shield' 'selfaura' | 'cobra' 'strike' | 'rakanothstrike' | 'firestorm' | 'kanemithfirestorm' | 'shock' 'web' | 'kanemithshockweb' | 'frozen' 'orb' | 'sharptoothunholyorb' | 'chain' 'lightning' | 'sharptoothchainpoison' | 'nova' | 'wispbossnova' | 'meteor' | 'radamentbossmeteor' | 'charge' | 'luciondash' | 'fissure' | 'eruptiondemonroadboss' | 'hydra' | 'tentacle' | 'charge' | 'lucioncharge' | 'smite' | 'monsmitelucion' | 'lower' 'resist' | 'monlowerres' | 'bone' 'spear' | 'bone' 'spear' 'putrid' 'defiler' | 'charged' 'bolt' | 'chargedboltimperialminiboss' | 'armageddon' | 'armageddon' 'selfaura');
class_only_skill: ('magic' 'arrow' '(' class 'only' ')' | 'magic' 'arrow' '(' class 'only' ')' | 'fire' 'arrow' '(' class 'only' ')' | 'fire' 'arrow' '(' class 'only' ')' | 'inner' 'sight' '(' class 'only' ')' | 'inner' 'sight' '(' class 'only' ')' | 'critical' 'strike' '(' class 'only' ')' | 'critical' 'strike' '(' class 'only' ')' | 'jab' '(' class 'only' ')' | 'jab' '(' class 'only' ')' | 'cold' 'arrow' '(' class 'only' ')' | 'cold' 'arrow' '(' class 'only' ')' | 'multiple' 'shot' '(' class 'only' ')' | 'multiple' 'shot' '(' class 'only' ')' | 'dodge' '(' class 'only' ')' | 'dodge' '(' class 'only' ')' | 'power' 'strike' '(' class 'only' ')' | 'power' 'strike' '(' class 'only' ')' | 'poison' 'javelin' '(' class 'only' ')' | 'poison' 'javelin' '(' class 'only' ')' | 'exploding' 'arrow' '(' class 'only' ')' | 'exploding' 'arrow' '(' class 'only' ')' | 'slow' 'movement' '(' class 'only' ')' | 'slow' 'movement' '(' class 'only' ')' | 'avoid' '(' class 'only' ')' | 'avoid' '(' class 'only' ')' | 'javelin' 'and' 'spear' 'mastery' '(' class 'only' ')' | 'javelin' 'and' 'spear' 'mastery' '(' class 'only' ')' | 'lightning' 'bolt' '(' class 'only' ')' | 'lightning' 'bolt' '(' class 'only' ')' | 'ice' 'arrow' '(' class 'only' ')' | 'ice' 'arrow' '(' class 'only' ')' | 'guided' 'arrow' '(' class 'only' ')' | 'guided' 'arrow' '(' class 'only' ')' | 'penetrate' '(' class 'only' ')' | 'penetrate' '(' class 'only' ')' | 'charged' 'strike' '(' class 'only' ')' | 'charged' 'strike' '(' class 'only' ')' | 'plague' 'javelin' '(' class 'only' ')' | 'plague' 'javelin' '(' class 'only' ')' | 'strafe' '(' class 'only' ')' | 'strafe' '(' class 'only' ')' | 'immolation' 'arrow' '(' class 'only' ')' | 'immolation' 'arrow' '(' class 'only' ')' | 'decoy' '(' class 'only' ')' | 'dopplezon' '(' class 'only' ')' | 'evade' '(' class 'only' ')' | 'evade' '(' class 'only' ')' | 'fend' '(' class 'only' ')' | 'fend' '(' class 'only' ')' | 'freezing' 'arrow' '(' class 'only' ')' | 'freezing' 'arrow' '(' class 'only' ')' | 'valkyrie' '(' class 'only' ')' | 'valkyrie' '(' class 'only' ')' | 'pierce' '(' class 'only' ')' | 'pierce' '(' class 'only' ')' | 'lightning' 'strike' '(' class 'only' ')' | 'lightning' 'strike' '(' class 'only' ')' | 'lightning' 'fury' '(' class 'only' ')' | 'lightning' 'fury' '(' class 'only' ')' | 'fire' 'bolt' '(' class 'only' ')' | 'fire' 'bolt' '(' class 'only' ')' | 'warmth' '(' class 'only' ')' | 'warmth' '(' class 'only' ')' | 'charged' 'bolt' '(' class 'only' ')' | 'charged' 'bolt' '(' class 'only' ')' | 'ice' 'bolt' '(' class 'only' ')' | 'ice' 'bolt' '(' class 'only' ')' | 'cold' 'enchant' '(' class 'only' ')' | 'cold' 'enchant' '(' class 'only' ')' | 'inferno' '(' class 'only' ')' | 'inferno' '(' class 'only' ')' | 'static' 'field' '(' class 'only' ')' | 'static' 'field' '(' class 'only' ')' | 'telekinesis' '(' class 'only' ')' | 'telekinesis' '(' class 'only' ')' | 'frost' 'nova' '(' class 'only' ')' | 'frost' 'nova' '(' class 'only' ')' | 'ice' 'blast' '(' class 'only' ')' | 'ice' 'blast' '(' class 'only' ')' | 'blaze' '(' class 'only' ')' | 'blaze' '(' class 'only' ')' | 'fire' 'ball' '(' class 'only' ')' | 'fire' 'ball' '(' class 'only' ')' | 'nova' '(' class 'only' ')' | 'nova' '(' class 'only' ')' | 'lightning' '(' class 'only' ')' | 'lightning' '(' class 'only' ')' | 'shiver' 'armor' '(' class 'only' ')' | 'shiver' 'armor' '(' class 'only' ')' | 'fire' 'wall' '(' class 'only' ')' | 'fire' 'wall' '(' class 'only' ')' | 'enchant' 'fire' '(' class 'only' ')' | 'enchant' '(' class 'only' ')' | 'chain' 'lightning' '(' class 'only' ')' | 'chain' 'lightning' '(' class 'only' ')' | 'teleport' '(' class 'only' ')' | 'teleport' '(' class 'only' ')' | 'glacial' 'spike' '(' class 'only' ')' | 'glacial' 'spike' '(' class 'only' ')' | 'meteor' '(' class 'only' ')' | 'meteor' '(' class 'only' ')' | 'thunder' 'storm' '(' class 'only' ')' | 'thunder' 'storm' '(' class 'only' ')' | 'energy' 'shield' '(' class 'only' ')' | 'energy' 'shield' '(' class 'only' ')' | 'blizzard' '(' class 'only' ')' | 'blizzard' '(' class 'only' ')' | 'chilling' 'armor' '(' class 'only' ')' | 'chilling' 'armor' '(' class 'only' ')' | 'fire' 'mastery' '(' class 'only' ')' | 'fire' 'mastery' '(' class 'only' ')' | 'hydra' '(' class 'only' ')' | 'hydra' '(' class 'only' ')' | 'lightning' 'mastery' '(' class 'only' ')' | 'lightning' 'mastery' '(' class 'only' ')' | 'frozen' 'orb' '(' class 'only' ')' | 'frozen' 'orb' '(' class 'only' ')' | 'cold' 'mastery' '(' class 'only' ')' | 'cold' 'mastery' '(' class 'only' ')' | 'amplify' 'damage' '(' class 'only' ')' | 'ampdmg' '(' class 'only' ')' | 'teeth' '(' class 'only' ')' | 'teeth' '(' class 'only' ')' | 'bone' 'armor' '(' class 'only' ')' | 'bone' 'armor' '(' class 'only' ')' | 'skeleton' 'mastery' '(' class 'only' ')' | 'skeleton' 'mastery' '(' class 'only' ')' | 'raise' 'skeleton' 'warrior' '(' class 'only' ')' | 'raise' 'skeleton' '(' class 'only' ')' | 'dim' 'vision' '(' class 'only' ')' | 'dim' 'vision' '(' class 'only' ')' | 'weaken' '(' class 'only' ')' | 'weaken' '(' class 'only' ')' | 'poison' 'strike' '(' class 'only' ')' | 'poison' 'dagger' '(' class 'only' ')' | 'corpse' 'explosion' '(' class 'only' ')' | 'corpse' 'explosion' '(' class 'only' ')' | 'clay' 'golem' '(' class 'only' ')' | 'clay' 'golem' '(' class 'only' ')' | 'iron' 'maiden' '(' class 'only' ')' | 'iron' 'maiden' '(' class 'only' ')' | 'terror' '(' class 'only' ')' | 'terror' '(' class 'only' ')' | 'bone' 'wall' '(' class 'only' ')' | 'bone' 'wall' '(' class 'only' ')' | 'golem' 'mastery' '(' class 'only' ')' | 'golem' 'mastery' '(' class 'only' ')' | 'raise' 'skeletal' 'mage' '(' class 'only' ')' | 'raise' 'skeletal' 'mage' '(' class 'only' ')' | 'confuse' '(' class 'only' ')' | 'confuse' '(' class 'only' ')' | 'life' 'tap' '(' class 'only' ')' | 'life' 'tap' '(' class 'only' ')' | 'desecrate' '(' class 'only' ')' | 'desecrate' '(' class 'only' ')' | 'bone' 'spear' '(' class 'only' ')' | 'bone' 'spear' '(' class 'only' ')' | 'blood' 'golem' '(' class 'only' ')' | 'bloodgolem' '(' class 'only' ')' | 'attract' '(' class 'only' ')' | 'attract' '(' class 'only' ')' | 'decrepify' '(' class 'only' ')' | 'decrepify' '(' class 'only' ')' | 'bone' 'prison' '(' class 'only' ')' | 'bone' 'prison' '(' class 'only' ')' | 'raise' 'skeleton' 'archer' '(' class 'only' ')' | 'raise' 'skeleton' 'archer' '(' class 'only' ')' | 'iron' 'golem' '(' class 'only' ')' | 'irongolem' '(' class 'only' ')' | 'lower' 'resist' '(' class 'only' ')' | 'lowres' '(' class 'only' ')' | 'poison' 'nova' '(' class 'only' ')' | 'poison' 'nova' '(' class 'only' ')' | 'bone' 'spirit' '(' class 'only' ')' | 'bone' 'spirit' '(' class 'only' ')' | 'fire' 'golem' '(' class 'only' ')' | 'firegolem' '(' class 'only' ')' | 'revive' '(' class 'only' ')' | 'revive' '(' class 'only' ')' | 'sacrifice' '(' class 'only' ')' | 'sacrifice' '(' class 'only' ')' | 'smite' '(' class 'only' ')' | 'smite' '(' class 'only' ')' | 'might' '(' class 'only' ')' | 'might' '(' class 'only' ')' | 'prayer' '(' class 'only' ')' | 'prayer' '(' class 'only' ')' | 'resist' 'fire' '(' class 'only' ')' | 'resist' 'fire' '(' class 'only' ')' | 'holy' 'bolt' '(' class 'only' ')' | 'holy' 'bolt' '(' class 'only' ')' | 'holy' 'fire' '(' class 'only' ')' | 'holy' 'fire' '(' class 'only' ')' | 'thorns' '(' class 'only' ')' | 'thorns' '(' class 'only' ')' | 'defiance' '(' class 'only' ')' | 'defiance' '(' class 'only' ')' | 'resist' 'cold' '(' class 'only' ')' | 'resist' 'cold' '(' class 'only' ')' | 'zeal' '(' class 'only' ')' | 'zeal' '(' class 'only' ')' | 'charge' '(' class 'only' ')' | 'charge' '(' class 'only' ')' | 'blessed' 'aim' '(' class 'only' ')' | 'blessed' 'aim' '(' class 'only' ')' | 'cleansing' '(' class 'only' ')' | 'cleansing' '(' class 'only' ')' | 'resist' 'lightning' '(' class 'only' ')' | 'resist' 'lightning' '(' class 'only' ')' | 'vengeance' '(' class 'only' ')' | 'vengeance' '(' class 'only' ')' | 'blessed' 'hammer' '(' class 'only' ')' | 'blessed' 'hammer' '(' class 'only' ')' | 'concentration' '(' class 'only' ')' | 'concentration' '(' class 'only' ')' | 'holy' 'freeze' '(' class 'only' ')' | 'holy' 'freeze' '(' class 'only' ')' | 'vigor' '(' class 'only' ')' | 'vigor' '(' class 'only' ')' | 'holy' 'sword' '(' class 'only' ')' | 'holy' 'sword' '(' class 'only' ')' | 'holy' 'shield' '(' class 'only' ')' | 'holy' 'shield' '(' class 'only' ')' | 'holy' 'shock' '(' class 'only' ')' | 'holy' 'shock' '(' class 'only' ')' | 'sanctuary' '(' class 'only' ')' | 'sanctuary' '(' class 'only' ')' | 'meditation' '(' class 'only' ')' | 'meditation' '(' class 'only' ')' | 'fist' 'of' 'the' 'heavens' '(' class 'only' ')' | 'fist' 'of' 'the' 'heavens' '(' class 'only' ')' | 'fanaticism' '(' class 'only' ')' | 'fanaticism' '(' class 'only' ')' | 'conviction' '(' class 'only' ')' | 'conviction' '(' class 'only' ')' | 'redemption' '(' class 'only' ')' | 'redemption' '(' class 'only' ')' | 'salvation' '(' class 'only' ')' | 'salvation' '(' class 'only' ')' | 'bash' '(' class 'only' ')' | 'bash' '(' class 'only' ')' | 'sword' 'mastery' '(' class 'only' ')' | 'sword' 'mastery' '(' class 'only' ')' | 'general' 'mastery' '(' class 'only' ')' | 'general' 'mastery' '(' class 'only' ')' | 'mace' 'mastery' '(' class 'only' ')' | 'mace' 'mastery' '(' class 'only' ')' | 'howl' '(' class 'only' ')' | 'howl' '(' class 'only' ')' | 'find' 'potion' '(' class 'only' ')' | 'find' 'potion' '(' class 'only' ')' | 'leap' '(' class 'only' ')' | 'leap' '(' class 'only' ')' | 'double' 'swing' '(' class 'only' ')' | 'double' 'swing' '(' class 'only' ')' | 'polearm' 'and' 'spear' 'mastery' '(' class 'only' ')' | 'pole' 'arm' 'and' 'spear' 'mastery' '(' class 'only' ')' | 'throwing' 'mastery' '(' class 'only' ')' | 'throwing' 'mastery' '(' class 'only' ')' | 'spear' 'mastery' '(' class 'only' ')' | 'spear' 'mastery' '(' class 'only' ')' | 'taunt' '(' class 'only' ')' | 'taunt' '(' class 'only' ')' | 'shout' '(' class 'only' ')' | 'shout' '(' class 'only' ')' | 'stun' '(' class 'only' ')' | 'stun' '(' class 'only' ')' | 'double' 'throw' '(' class 'only' ')' | 'double' 'throw' '(' class 'only' ')' | 'combat' 'reflexes' '(' class 'only' ')' | 'combat' 'reflexes' '(' class 'only' ')' | 'find' 'item' '(' class 'only' ')' | 'find' 'item' '(' class 'only' ')' | 'leap' 'attack' '(' class 'only' ')' | 'leap' 'attack' '(' class 'only' ')' | 'concentrate' '(' class 'only' ')' | 'concentrate' '(' class 'only' ')' | 'iron' 'skin' '(' class 'only' ')' | 'iron' 'skin' '(' class 'only' ')' | 'battle' 'cry' '(' class 'only' ')' | 'battle' 'cry' '(' class 'only' ')' | 'frenzy' '(' class 'only' ')' | 'frenzy' '(' class 'only' ')' | 'increased' 'speed' '(' class 'only' ')' | 'increased' 'speed' '(' class 'only' ')' | 'battle' 'orders' '(' class 'only' ')' | 'battle' 'orders' '(' class 'only' ')' | 'grim' 'ward' '(' class 'only' ')' | 'grim' 'ward' '(' class 'only' ')' | 'whirlwind' '(' class 'only' ')' | 'whirlwind' '(' class 'only' ')' | 'berserk' '(' class 'only' ')' | 'berserk' '(' class 'only' ')' | 'natural' 'resistance' '(' class 'only' ')' | 'natural' 'resistance' '(' class 'only' ')' | 'war' 'cry' '(' class 'only' ')' | 'war' 'cry' '(' class 'only' ')' | 'battle' 'command' '(' class 'only' ')' | 'battle' 'command' '(' class 'only' ')' | 'raven' '(' class 'only' ')' | 'raven' '(' class 'only' ')' | 'poison' 'creeper' '(' class 'only' ')' | 'plague' 'poppy' '(' class 'only' ')' | 'werewolf' '(' class 'only' ')' | 'wearwolf' '(' class 'only' ')' | 'lycanthropy' '(' class 'only' ')' | 'shape' 'shifting' '(' class 'only' ')' | 'firestorm' '(' class 'only' ')' | 'firestorm' '(' class 'only' ')' | 'oak' 'sage' '(' class 'only' ')' | 'oak' 'sage' '(' class 'only' ')' | 'summon' 'spirit' 'wolf' '(' class 'only' ')' | 'summon' 'spirit' 'wolf' '(' class 'only' ')' | 'werebear' '(' class 'only' ')' | 'wearbear' '(' class 'only' ')' | 'molten' 'boulder' '(' class 'only' ')' | 'molten' 'boulder' '(' class 'only' ')' | 'arctic' 'blast' '(' class 'only' ')' | 'arctic' 'blast' '(' class 'only' ')' | 'carrion' 'vine' '(' class 'only' ')' | 'cycle' 'of' 'life' '(' class 'only' ')' | 'feral' 'rage' '(' class 'only' ')' | 'feral' 'rage' '(' class 'only' ')' | 'maul' '(' class 'only' ')' | 'maul' '(' class 'only' ')' | 'fissure' '(' class 'only' ')' | 'eruption' '(' class 'only' ')' | 'cyclone' 'armor' '(' class 'only' ')' | 'cyclone' 'armor' '(' class 'only' ')' | 'heart' 'of' 'wolverine' '(' class 'only' ')' | 'heart' 'of' 'wolverine' '(' class 'only' ')' | 'summon' 'dire' 'wolf' '(' class 'only' ')' | 'summon' 'fenris' '(' class 'only' ')' | 'rabies' '(' class 'only' ')' | 'rabies' '(' class 'only' ')' | 'fire' 'claws' '(' class 'only' ')' | 'fire' 'claws' '(' class 'only' ')' | 'twister' '(' class 'only' ')' | 'twister' '(' class 'only' ')' | 'solar' 'creeper' '(' class 'only' ')' | 'vines' '(' class 'only' ')' | 'hunger' '(' class 'only' ')' | 'hunger' '(' class 'only' ')' | 'shock' 'wave' '(' class 'only' ')' | 'shock' 'wave' '(' class 'only' ')' | 'volcano' '(' class 'only' ')' | 'volcano' '(' class 'only' ')' | 'tornado' '(' class 'only' ')' | 'tornado' '(' class 'only' ')' | 'spirit' 'of' 'barbs' '(' class 'only' ')' | 'spirit' 'of' 'barbs' '(' class 'only' ')' | 'summon' 'grizzly' '(' class 'only' ')' | 'summon' 'grizzly' '(' class 'only' ')' | 'fury' '(' class 'only' ')' | 'fury' '(' class 'only' ')' | 'armageddon' '(' class 'only' ')' | 'armageddon' '(' class 'only' ')' | 'hurricane' '(' class 'only' ')' | 'hurricane' '(' class 'only' ')' | 'fire' 'blast' '(' class 'only' ')' | 'fire' 'trauma' '(' class 'only' ')' | 'claw' 'and' 'dagger' 'mastery' '(' class 'only' ')' | 'claw' 'mastery' '(' class 'only' ')' | 'psychic' 'hammer' '(' class 'only' ')' | 'psychic' 'hammer' '(' class 'only' ')' | 'tiger' 'strike' '(' class 'only' ')' | 'tiger' 'strike' '(' class 'only' ')' | 'dragon' 'talon' '(' class 'only' ')' | 'dragon' 'talon' '(' class 'only' ')' | 'shock' 'web' '(' class 'only' ')' | 'shock' 'field' '(' class 'only' ')' | 'blade' 'sentinel' '(' class 'only' ')' | 'blade' 'sentinel' '(' class 'only' ')' | 'burst' 'of' 'speed' '(' class 'only' ')' | 'quickness' '(' class 'only' ')' | 'fists' 'of' 'fire' '(' class 'only' ')' | 'fists' 'of' 'fire' '(' class 'only' ')' | 'dragon' 'claw' '(' class 'only' ')' | 'dragon' 'claw' '(' class 'only' ')' | 'charged' 'bolt' 'sentry' '(' class 'only' ')' | 'charged' 'bolt' 'sentry' '(' class 'only' ')' | 'wake' 'of' 'fire' '(' class 'only' ')' | 'wake' 'of' 'fire' 'sentry' '(' class 'only' ')' | 'weapon' 'block' '(' class 'only' ')' | 'weapon' 'block' '(' class 'only' ')' | 'cloak' 'of' 'shadows' '(' class 'only' ')' | 'cloak' 'of' 'shadows' '(' class 'only' ')' | 'cobra' 'strike' '(' class 'only' ')' | 'cobra' 'strike' '(' class 'only' ')' | 'blade' 'fury' '(' class 'only' ')' | 'blade' 'fury' '(' class 'only' ')' | 'fade' '(' class 'only' ')' | 'fade' '(' class 'only' ')' | 'shadow' 'warrior' '(' class 'only' ')' | 'shadow' 'warrior' '(' class 'only' ')' | 'claws' 'of' 'thunder' '(' class 'only' ')' | 'claws' 'of' 'thunder' '(' class 'only' ')' | 'dragon' 'tail' '(' class 'only' ')' | 'dragon' 'tail' '(' class 'only' ')' | 'chain' 'lightning' 'sentry' '(' class 'only' ')' | 'chain' 'lightning' 'sentry' '(' class 'only' ')' | 'wake' 'of' 'inferno' '(' class 'only' ')' | 'inferno' 'sentry' '(' class 'only' ')' | 'mind' 'blast' '(' class 'only' ')' | 'mind' 'blast' '(' class 'only' ')' | 'blades' 'of' 'ice' '(' class 'only' ')' | 'blades' 'of' 'ice' '(' class 'only' ')' | 'dragon' 'flight' '(' class 'only' ')' | 'dragon' 'flight' '(' class 'only' ')' | 'death' 'sentry' '(' class 'only' ')' | 'death' 'sentry' '(' class 'only' ')' | 'blade' 'shield' '(' class 'only' ')' | 'blade' 'shield' '(' class 'only' ')' | 'venom' '(' class 'only' ')' | 'venom' '(' class 'only' ')' | 'shadow' 'master' '(' class 'only' ')' | 'shadow' 'master' '(' class 'only' ')' | 'phoenix' 'strike' '(' class 'only' ')' | 'royal' 'strike' '(' class 'only' ')' | 'holy' 'nova' '(' class 'only' ')' | 'holy' 'nova' '(' class 'only' ')' | 'freezing' 'arrow' '(' class 'only' ')' | 'shattering' 'arrow' '(' class 'only' ')' | 'lightning' 'sentry' '(' class 'only' ')' | 'lightning' 'sentry' '(' class 'only' ')' | 'blood' 'warp' '(' class 'only' ')' | 'blood' 'warp' '(' class 'only' ')' | 'deep' 'wounds' '(' class 'only' ')' | 'deep' 'wounds' '(' class 'only' ')' | 'ice' 'barrage' '(' class 'only' ')' | 'ice' 'barrage' '(' class 'only' ')' | 'gust' '(' class 'only' ')' | 'gust' '(' class 'only' ')' | 'holy' 'light' '(' class 'only' ')' | 'holy' 'light' '(' class 'only' ')' | 'curse' 'mastery' '(' class 'only' ')' | 'curmas' '(' class 'only' ')' | 'combustion' '(' class 'only' ')' | 'combustion' '(' class 'only' ')' | 'joust' '(' class 'only' ')' | 'joust' '(' class 'only' ')' | 'dark' 'pact' '(' class 'only' ')' | 'dark' 'pact' '(' class 'only' ')' | 'lesser' 'hydra' '(' class 'only' ')' | 'lesser' 'hydra' '(' class 'only' ')');
class: 'amazon' | 'sorceress' | 'necromancer' | 'paladin' | 'barbarian' | 'druid' | 'assassin';
property: (strength|dgrp1|energy|dexterity|vitality|maxhp|maxmana|maxstamina|item_armor_percent|item_maxdamage_percent|item_mindamage_percent|tohit|toblock|mindamage|maxdamage|secondary_mindamage|secondary_maxdamage|manarecoverybonus|staminarecoverybonus|armorclass|armorclass_vs_missile|armorclass_vs_hth|normal_damage_reduction|magic_damage_reduction|damageresist|magicresist|maxmagicresist|fireresist|dgrp2|maxfireresist|lightresist|maxlightresist|coldresist|maxcoldresist|poisonresist|maxpoisonresist|firemindam|firemaxdam|lightmindam|lightmaxdam|magicmindam|magicmaxdam|coldmindam|coldmaxdam|poisonmindam|poisonmaxdam|lifedrainmindam|manadrainmindam|hpregen|item_maxdurability_percent|item_maxhp_percent|item_maxmana_percent|item_attackertakesdamage|item_goldbonus|item_magicbonus|item_knockback|item_addclassskills|item_addexperience|item_healafterkill|item_reducedprices|item_lightradius|item_req_percent|item_fasterattackrate|item_fastermovevelocity|item_nonclassskill|item_fastergethitrate|item_fasterblockrate|item_fastercastrate|item_singleskill|item_restinpeace|curse_resistance|item_poisonlengthresist|item_normaldamage|item_howl|item_stupidity|item_damagetomana|item_ignoretargetac|item_fractionaltargetac|item_preventheal|item_halffreezeduration|item_tohit_percent|item_damagetargetac|item_demondamage_percent|item_undeaddamage_percent|item_demon_tohit|item_undead_tohit|item_throwable|item_allskills|item_attackertakeslightdamage|item_freeze|item_openwounds|item_crushingblow|item_kickdamage|item_manaafterkill|item_healafterdemonkill|item_deadlystrike|item_absorbfire_percent|item_absorbfire|item_absorblight_percent|item_absorblight|item_absorbmagic_percent|item_absorbmagic|item_absorbcold_percent|item_absorbcold|item_slow|item_aura|item_indesctructible|item_cannotbefrozen|item_staminadrainpct|item_reanimate|item_pierce|item_magicarrow|item_explosivearrow|attack_vs_montype|damage_vs_montype|uber_difficulty|map_glob_boss_dropskillers|map_glob_boss_dropcorruptedunique|item_addskill_tab|item_skillonequip|extra_shadow|extra_spiritwolf|item_skillonattack|item_skillonkill|item_skillondeath|item_skillonhit|item_skillonlevelup|item_skilloncast|item_skillongethit|item_skillonblock|item_skilloncrit|item_charged_skill|item_skillonpierce|desecrated|joustreduction_zeraes|item_maxdeadlystrike|map_glob_boss_dropubermats|map_glob_boss_droppuzzlebox|item_mindamage_energy|item_armor_perlevel|item_armorpercent_perlevel|item_hp_perlevel|item_mana_perlevel|item_maxdamage_perlevel|item_maxdamage_percent_perlevel|item_strength_perlevel|item_dexterity_perlevel|item_energy_perlevel|item_vitality_perlevel|item_tohit_perlevel|item_tohitpercent_perlevel|item_cold_damagemax_perlevel|item_fire_damagemax_perlevel|item_ltng_damagemax_perlevel|item_pois_damagemax_perlevel|item_resist_cold_perlevel|item_resist_fire_perlevel|item_resist_ltng_perlevel|item_resist_pois_perlevel|item_absorb_cold_perlevel|item_absorb_fire_perlevel|item_absorb_ltng_perlevel|item_thorns_perlevel|item_find_gold_perlevel|item_find_magic_perlevel|item_regenstamina_perlevel|item_stamina_perlevel|item_damage_demon_perlevel|item_damage_undead_perlevel|item_tohit_demon_perlevel|item_tohit_undead_perlevel|item_crushingblow_perlevel|item_openwounds_perlevel|item_kick_damage_perlevel|item_deadlystrike_perlevel|item_replenish_durability|item_replenish_quantity|item_extra_stack|item_crushingblow_efficiency|extra_cold_arrows|item_shiny_appearance|item_pierce_cold|item_pierce_fire|item_pierce_ltng|item_pierce_pois|passive_fire_mastery|passive_ltng_mastery|passive_cold_mastery|passive_pois_mastery|passive_fire_pierce|passive_ltng_pierce|passive_cold_pierce|passive_pois_pierce|passive_mag_mastery|item_splashonhit|corrupted|item_elemskill_cold|item_elemskill_fire|item_elemskill_lightning|item_elemskill_poison|item_elemskill_magic|max_curses|map_defense|map_play_magicbonus|dgrp6|map_play_goldbonus|map_glob_density|map_play_addexperience|map_glob_arealevel|map_glob_monsterrarity|map_mon_firemindam|map_mon_firemaxdam|map_mon_lightmindam|map_mon_lightmaxdam|map_mon_magicmindam|map_mon_magicmaxdam|map_mon_coldmindam|map_mon_coldmaxdam|map_mon_poisonmindam|map_mon_poisonmaxdam|map_mon_passive_fire_mastery|map_mon_passive_ltng_mastery|map_mon_passive_cold_mastery|map_mon_passive_pois_mastery|map_mon_fasterattackrate|dgrp4|map_mon_fastercastrate|map_mon_tohit|dgrp5|map_mon_acpercentage|map_mon_absorbcold_percent|map_mon_absorbmagic_percent|map_mon_absorblight_percent|map_mon_absorbfire_percent|map_mon_normal_damage_reduction|map_mon_velocitypercent|map_mon_hpregen|map_mon_lifedrainmindam|map_mon_fastergethitrate|map_mon_maxhp_percent|map_mon_pierce|map_mon_openwounds|map_mon_crushingblow|map_mon_curse_resistance|map_play_acpercentage|map_play_fastergethitrate|map_play_toblock|map_play_hpregen|map_play_maxfireresist|dgrp8|map_play_maxlightresist|map_play_maxcoldresist|map_play_maxpoisonresist|item_replenish_charges|item_leap_speed|item_healafterhit|passive_phys_pierce|map_mon_edpercentage|map_mon_splash|map_play_fireresist|dgrp3|map_play_lightresist|map_play_coldresist|map_play_poisonresist|map_mon_phys_as_extra_ltng|map_mon_phys_as_extra_cold|map_mon_phys_as_extra_fire|map_mon_phys_as_extra_pois|map_mon_phys_as_extra_mag|map_glob_add_mon_doll|map_glob_add_mon_succ|map_glob_add_mon_vamp|map_glob_add_mon_cow|map_glob_add_mon_horde|map_glob_add_mon_ghost|extra_bonespears|extra_revives|immune_stat|mon_cooldown1|mon_cooldown2|mon_cooldown3|map_mon_deadlystrike|map_mon_cannotbefrozen|map_play_fasterattackrate|dgrp7|map_play_fastercastrate|map_mon_skillondeath|map_play_maxhp_percent|map_play_maxmana_percent|map_play_damageresist|map_play_velocitypercent|heroic|extra_spirits|gustreduction|extra_skele_war|extra_skele_mage|extra_hydra|extra_valk|joustreduction|grims_extra_skele_mage|map_play_lightradius|blood_warp_life_reduction|map_glob_add_mon_souls|map_glob_add_mon_fetish|dclone_clout|maxlevel_clout|dev_clout|extra_skele_archer|extra_golem|inc_splash_radius|item_numsockets_textonly|rathma_clout|dragonflightreduction|item_dmgpercent_pereth|corpseexplosionradius|mirrored|item_dmgpercent_permissinghppercent|lifedrain_percentcap|inc_splash_radius_permissinghp|eaglehorn_raven|map_glob_skirmish_mode|map_mon_dropjewelry|map_mon_dropweapons|map_mon_droparmor|map_mon_dropcrafting|map_glob_extra_boss|map_glob_add_mon_shriek|map_force_event|deep_wounds|map_mon_dropcharms|map_glob_dropcorrupted|curse_effectiveness|map_glob_boss_dropfacet|map_mon_dropjewels|map_glob_sundermonsters|extra_grizzly|no_wolves) EOF;
